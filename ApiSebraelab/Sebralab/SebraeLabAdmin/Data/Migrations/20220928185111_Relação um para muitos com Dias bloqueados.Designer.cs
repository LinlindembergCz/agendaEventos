...
namespace SebraeLab.Evento.Data.Migrations
{
    ...
    [Migration("20220928185111_Relação um para muitos com Dias bloqueados")]
    partial class RelaçãoumparamuitoscomDiasbloqueados
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SebraeLab.Evento.Domain.DiaBloqueado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DiasBloqueoados", (string)null);
                });
            ...
            modelBuilder.Entity("SebraeLab.Evento.Domain.DiaBloqueado", b =>
                {
                    b.HasOne("SebraeLab.Evento.Domain.Bloqueador", "Bloqueador")
                        .WithMany("Dias")
