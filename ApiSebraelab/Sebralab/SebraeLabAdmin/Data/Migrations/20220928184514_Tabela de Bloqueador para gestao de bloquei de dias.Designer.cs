...
namespace SebraeLab.Evento.Data.Migrations
{
    ...
    [Migration("20220928184514_Tabela de Bloqueador para gestao de bloquei de dias")]
    partial class TabeladeBloqueadorparagestaodebloqueidedias
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SebraeLab.Evento.Domain.Bloqueador", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SebraeLab.Evento.Domain.DiaBloqueiado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BloqueiadorId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BloqueiadorId");

                    b.ToTable("DiasBloqueioados", (string)null);
                });
            ...
            modelBuilder.Entity("SebraeLab.Evento.Domain.DiaBloqueiado", b =>
                {
                    b.HasOne("SebraeLab.Evento.Domain.Bloqueador", "Bloqueiador")
                        .WithMany("Dias")
                        .HasForeignKey("BloqueiadorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Bloqueiador");
                });
